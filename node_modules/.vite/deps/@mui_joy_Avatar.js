"use client";
import "./chunk-AFLAQ6S2.js";
import "./chunk-GSZ7ISAW.js";
import "./chunk-MV5UOIPP.js";
import {
  styled_default,
  useSlot,
  useThemeProps
} from "./chunk-XVG6VGJM.js";
import "./chunk-BX5H3U3B.js";
import "./chunk-5WYIPVHZ.js";
import {
  generateUtilityClass,
  generateUtilityClasses
} from "./chunk-JB27GCLD.js";
import {
  _extends,
...
var _excluded2 = ["className", "color", "component", "size", "variant", "children", "slots", "slotProps"];
var AvatarGroupContext = React4.createContext(void 0);
...
var AvatarGroup = React4.forwardRef(function AvatarGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime5.jsx)(AvatarGroupContext.Provider, {
    value: ownerState,
...
var _excluded3 = ["alt", "color", "size", "variant", "src", "srcSet", "children", "component", "slots", "slotProps"];
...
var Avatar = React5.forwardRef(function Avatar2(inProps, ref) {
  ...
  const groupContext = React5.useContext(AvatarGroupContext);
  const {
    alt,
  ...
  if (hasImgNotFailing) {
    children = (0, import_jsx_runtime6.jsx)(SlotImg, _extends({}, imageProps));
  } else if (childrenProp != null) {
    children = childrenProp;
  } else if (alt) {
    children = alt[0];
  } else {
    children = (0, import_jsx_runtime6.jsx)(SlotFallback, _extends({}, fallbackProps));
  }
